...
public class FailureReportAssessment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Failure Report (Assessments Based)");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Index", "Student ID", "Student Name", "Failed Assessment", "Assessment total Marks", "Assessment Obtained Marks"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FailureReportAssessment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FailureReportAssessment().setVisible(true);
            }
        });
    }
