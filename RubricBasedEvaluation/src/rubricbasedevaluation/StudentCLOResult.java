 ...
 * @author Ahsan
 */
public class StudentCLOResult extends javax.swing.JFrame {

    /**
     * Creates new form StudentCLOResult
     */
    public StudentCLOResult() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Student CLO Result");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Index", "CLO Number", "Total Marks", "Obtained Marks", "Percentage"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentCLOResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentCLOResult().setVisible(true);
            }
        });
    }
